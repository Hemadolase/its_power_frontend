...
const Header = () => {
  ...
  <div className="d-flex d-md-none flex-column mobile-topbar">
    ...
    <div className="d-flex justify-content-between align-items-center px-2">
      ...
      <div className="social-icons-mobile">
        <a href="https://www.facebook.com/suresh.iramani.1/" target="_blank" className="top-icon me-3"><i className="fab fa-facebook-f"></i></a>
      ...
      <a href="https://www.instagram.com/itspowerinfrastructure/" target="_blank" className="top-icon"><i className="fab fa-instagram"></i></a>
      </div>
    </div>
  ...
  <div className="row align-items-center desktop-header d-none d-md-flex">
    ...
    <div className="col-md-6 text-end">
      ...
      <a href="https://www.google.com"  target="_blank" className="top-icon me-3"><i className="fab fa-google"></i></a>
      <a href="https://www.linkedin.com/company/its-power-&-infrastructure-pvt-ltd/posts/?feedView=all" target="_blank" className="top-icon me-3"><i className="fab fa-linkedin"></i></a>
      <a href="https://www.instagram.com/itspowerinfrastructure/" target="_blank" className="top-icon me-3"><i className="fab fa-instagram"></i></a>
