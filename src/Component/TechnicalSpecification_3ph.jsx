...
function TechnicalSpecification_3ph() {
  return (
    <div className="tech-spec-container">
      ...
      <div className="tech-header">
        ...
        <p>10 KVA – 30 KVA | 3 Phase Input → 1 Phase Output</p>
      </div>
        ...
        <table className="tech-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>350V – 500V AC (3 Phase), 45–55 Hz</td>
            </tr>
            ...
            <tr>
              ...
              <td>±5% deviation for 100% step load, recovers within ½ cycle</td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <ul className="tech-list">
                  ...
                  <li>Phase Failure / Phase Reverse</li>
                  <li>Battery Low Warning</li>
...
export default TechnicalSpecification_3ph;
